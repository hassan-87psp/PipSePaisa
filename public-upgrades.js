(function(){
  ...
  function setupNavigation(){
    ...
    const defs=[
      ...
      ['Become Partner','/becomepartner','/becomepartner'],
      ['Trading Tools & Services','/tradingtools','/tradingtools']
    ];
    ...
    const activePath=aliases[path]||(path==='/free-course'?'/courses':path);
  ...
  function fixLinks(){
    ...
    const partnerLinks=[
      ...
      ['XM','Open XM Partner Account →','https://affs.click/CrNti'],
