...
function refresh(table){
  const userMap={
    ...
    course_enrollments:()=>call('loadMyCourses'),
    site_settings:async()=>{await call('loadTabSettings');call('applyTabSettings');location.dispatchEvent(new Event('psp-settings-updated'))},
