(function(){
  ...
  function conversionRate(enrollments,signups){const s=Number(signups||0),e=Math.min(Number(enrollments||0),s);return s>0?Math.min(100,(e/s)*100):0;}
  ...
  function addMenuAndPage(){
    ...
    page.innerHTML=`
      ...
      <div class="card">
        <div class="card-header"><div><div class="card-title">Tracked Links Performance</div><div class="card-meta">Clicks, unique visitors and conversions update automatically. Conversion = enrolled users ÷ signups. Enrolled users are limited to the same-link signup cohort.</div></div><button class="btn btn-secondary btn-sm" id="lmRefreshBtn">↻ Refresh</button></div>
