...
(function(){
  ...
  function load(){
    ...
    var sc=document.createElement('script');sc.src='/ea-indicator-user-v215.js?v=20260911-v222-sidebar';sc.defer=true;sc.dataset.pspEaiV215='1';document.head.appendChild(sc);
  }
