...
(function(){
  ...
  function load(){
    ...
    var sc=document.createElement('script');sc.src='/ea-indicator-user-v215.js?v=20260916-v241-sessions-sidebar-final';sc.defer=true;sc.dataset.pspEaiV215='1';document.head.appendChild(sc);
  }
