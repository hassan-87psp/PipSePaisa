...
var SYSTEM_COURSE_DEFAULTS={
  basic:{id:'',title:'Basic Forex Course',description:'9 beginner modules covering Forex foundations, technical analysis, fundamentals, psychology and risk management.',level:'Beginner',category:'System Course',thumbnail:'/course-thumbnails/basic-forex-course.webp?v=20260801-v27-final',thumbnail_emoji:'📘',thumbnail_color:1,price:0,display_order:1,enrollments_count:0,is_published:true,is_premium:false},
  advanced:{id:'',title:'Advanced Forex Course',description:'9 professional modules with advanced structure, liquidity, execution, risk, macro analysis and strategy development.',level:'Advanced',category:'System Course',thumbnail:'/course-thumbnails/advanced-forex-course.webp?v=20260801-v27-final',thumbnail_emoji:'🚀',thumbnail_color:2,price:200,display_order:2,enrollments_count:0,is_published:true,is_premium:true}
};
...
window.loadAdminCourses=async function(){
  ...
  function thumbnail(course,fallback){var src=String(course.thumbnail||fallback||'');if(!src||/(?:service-banners\/)|forex-education-(?:light|dark)|trading-platform.*education/i.test(src))src=fallback;return '<div class="psp-system-course-thumbnail"><img src="'+esc(src)+'" alt="'+esc(course.title||'Course')+' thumbnail" onerror="this.onerror=null;this.src=\''+esc(fallback)+'\'"><span>16:9 Course Thumbnail</span></div>'}
